...
public class MainController extends HttpServlet {
    ...
    private static final String SEARCH_STATUS = "SearchByStatusController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("Search".equals(action)) {               //Search
                url = SEARCH;
            } else if ("Delete".equals(action)) {          //Delete
                url = DELETE;
            } else if ("Update".equals(action)) {          //Update
                url = UPDATE;
            }else if ("Search by status".equals(action)) {          //Update
                url = SEARCH_STATUS;
            }else if("Create".equals(action)){          //Create 
                url=CREATE;              
            }else {
